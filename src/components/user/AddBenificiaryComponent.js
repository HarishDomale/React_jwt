...
const AddBenificiaryComponent = () => {
    ...
    const saveOrUpdateBenificiary=(e)=>{
        ...
        const benificiary={firstName,middleName,lastName,motherName,dob,address,mobNo,blood,weight,gender}
...
export default AddBenificiaryComponent